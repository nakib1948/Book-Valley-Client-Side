    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        {publisherdata.map((data, index) => (
          <div key={index} className="card w-full bg-slate-100 text-gray-700 ">
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <button className="btn bg-deepblue text-white font-semibold rounded-full">Send Request</button>
              </div>
            </div>
          </div>
        ))}
