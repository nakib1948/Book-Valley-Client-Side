      ...
      <div className="grid grid-cols-1 my-10 md:grid-cols-6 gap-6 lg:grid-cols-2">
        ...
        <div className="stats  py-5 bg-pink-400 text-primary-content">
          <div className="stat">
            ...
            <div className="stat-value text-gray-800 flex">{data.publishedBook.booksold}<img src={book} className="h-8 mt-2" alt="" /></div>
          </div>
        </div>
        <div className="stats  py-5 bg-sky-500 text-primary-content">
          <div className="stat">
            ...
            <div className="stat-value text-gray-800">${data.publishedBook.totalEarning}</div>
          </div>
        </div>
        ...
        <div className="stats  py-5 bg-cyan-500 text-primary-content">
          <div className="stat">
            ...
            <div className="stat-value text-gray-800 flex">{data.freeBook}<img src={book} className="h-8 mt-2" alt="" /></div>
          </div>
        </div>
      </div>
